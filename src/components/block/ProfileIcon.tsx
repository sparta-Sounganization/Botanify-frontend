...
export default function ProfileIcon({ user }: { user: User }) {
	return (
		<a href="/mypage" className="relative flex flex-col items-center my-auto mx-5">
			<span className={`
          ...
          `
			...
			<span className="absolute bottom-[-22] whitespace-nowrap text-sm text-gray-700">{user.username}</span>
		</a>
	)
}